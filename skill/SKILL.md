...
- "not just X, but Y" — ~6% of sampled ChatGPT messages; EQ-Bench's Slop Score weights "not-x-but-y" patterns at 25% of its composite, with LLMs running 0.09–0.81 per 1k characters vs human 0.04 (EQ-Bench, Jul 2026)
...
- rule of three · false ranges · vague attribution — Codified by Wikipedia's guide; structural, so harder to tune out
<!-- TRENDING:END -->
