<!-- MEDIUM VERSION. Paste the body below into a new Medium story. -->
<!-- Title:    I ran three AI-writing checkers over the same 456 documents -->
<!-- Subtitle: Three rule sets written by three people, one pile of text. Where they agree, where they are wrong in the same way, and the dataset nobody in this field has. -->
<!-- Canonical: https://humansounding.com/blog/do-ai-writing-checkers-agree.html -->
...
*Method: the corpora, the generator, and the measurement scripts are in the
[study directory](https://github.com/wyvernkalyx/humansounding/tree/main/study).
Rates are per 1,000 words. The two outside rule sets are
[amanmaqsood/prose-humanizer](https://github.com/amanmaqsood/prose-humanizer)
and [aashaexo/soundshuman](https://github.com/aashaexo/soundshuman), both MIT,
both run unmodified through their own command-line tools. The human baseline
throughout is 40 Medium articles published between 2018 and 2022; author
identities were not recorded.*

*This first appeared on [humansounding.com](https://humansounding.com/blog/do-ai-writing-checkers-agree.html),
which catalogs AI-writing tells and publishes rates rather than verdicts.
Claude drafted the prose from my notes, and I revised it.*
